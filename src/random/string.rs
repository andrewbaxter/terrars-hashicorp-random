...
struct String_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<StringData>,
}

#[derive(Clone)]
pub struct String(Rc<String_>);
...
impl Dependable for String {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for String {
    type O = ListRef<StringRef>;
...
impl BuildString {
    pub fn build(self, stack: &mut Stack) -> String {
        let out = String(Rc::new(String_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(StringData {
